...
def readf():
    try:
        ...
        sys.exit(1)
readf()
#Command to resize image - to be run from cmd
#python Image_Resize_for_Training.py -path-to-the-source-images-folder-in-which-there-are-sub-folders-of-categories-in-quotes size-to-be-resized -path-where-resized-images-will-be-put-with-folder-name
#If folder does not exist, it will be created
#Example command
#python Image_Resize_for_Training.py "E:\AI_Projects\Image_Recognition_Chef_Police_Engineer\New_images" 224 "E:\AI_Projects\Image_Recognition_Chef_Police_Engineer\New_images_resized"
