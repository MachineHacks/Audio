...
class ModelTraining:
    ...
    def setDataDirectory(self, data_directory="/home/vaishali/Desktop/Rohit_data1/New_images_resized"):
        """
    ...
    def trainModel(self, num_objects, num_experiments=10, enhance_data=False, batch_size = 16, initial_learning_rate=1e-3, show_network_summary=False, training_image_size = 224):
...
model_trainer.trainModel(num_objects=8, num_experiments=10, enhance_data=True, batch_size=64, show_network_summary=True)
